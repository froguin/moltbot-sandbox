...
| OpenRouter | `openrouter/upstage/solar-pro-3:free` | OpenRouter API key |
...
| `OPENCLAW_AI_GATEWAY_API` | No | Force API adapter for AI Gateway model providers (e.g. `openai-completions`, `anthropic-messages`) |
